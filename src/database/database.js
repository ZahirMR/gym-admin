...
export const insertGanancia = (ganancia) => firebaseDb.insertGanancia(ganancia);
export const getGanancias = () => firebaseDb.getGanancias();
export const getTotalGanancias = () => firebaseDb.getTotalGanancias();
